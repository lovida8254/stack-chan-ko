...
class Face {
 protected:   // was private — exposed for subclasses (ImageFace) that need direct sprite access
  Drawable *mouth;
  Drawable *eyeR;
  Drawable *eyeL;
  Drawable *eyeblowR;
 ...
 public:
  ...
  virtual void draw(DrawContext *ctx);   // virtual: ImageFace overrides to blit SD-loaded sprites

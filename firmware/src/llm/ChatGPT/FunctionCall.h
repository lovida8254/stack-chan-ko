...
// Boot-time entry point: spawns the background data-refresh task that fills the
// external API caches (weather, air, meals, todos, schedules) every ~5 min.
// Call once from main.cpp setup() AFTER Wi-Fi connect + NTP sync.
